...
root.config(bg="#8F00FF")


# Main Frame
Main_frame = LabelFrame(root , padx=100 ,  pady=7 , borderwidth=3 ,  relief="raised")
Main_frame.config(bg="#8F00FF")
Main_frame.grid(row = 0 ,  column= 1 ,  padx= 55 ,  pady =  10)

# Text Lable 
Text_lable = Label(Main_frame, text = "AI Assistant" , font=("comic Sans ms" ,  14 , "bold" ) , bg = "#556B2F")
...
text=Text(root , font= ('Courier 10 bold') , bg = "#BF7FFF")
...
# Add a text button1
button1 =  Button(root,  text="ASK" , bg="#00CFFF" , pady=16 ,  padx=40,  borderwidth=3 , relief=SOLID ,  command=ask)
button1.place(x= 70, y= 575)

# Add a text button2
button2 =  Button(root,  text="Send" , bg="#00CFFF" , pady=16 ,  padx=40,  borderwidth=3 , relief=SOLID ,  command=User_send)
button2.place(x= 400, y= 575)

# Add a text button3
button3 = Button(root, text="Delete", bg="#00CFFF" , pady=16 ,  padx=40,  borderwidth=3 , relief=SOLID ,command=delete_text)
